import * as pdfjsLib from '../../../third_party/pdfjs/build/pdf.mjs';
import { TextLayer } from '../../../third_party/pdfjs/build/pdf.mjs';

pdfjsLib.GlobalWorkerOptions.workerSrc = new URL('../../../third_party/pdfjs/build/pdf.worker.mjs', import.meta.url).toString();
...
root.addEventListener('mousedown', (ev) => {
  ...
  const refs = state.pages.get(pageNo);
