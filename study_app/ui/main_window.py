...
class StudyQueuePage(QWidget):
    def __init__(
        ...
        history_col.addWidget(QLabel("Review History"))
        history_col.addWidget(self.review_history_list)
        history_col.addWidget(self.full_history_btn)
        history_col.addStretch()
        control_row.addLayout(history_col)
