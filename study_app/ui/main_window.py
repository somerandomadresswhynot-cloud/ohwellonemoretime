...
class StudyQueuePage(QWidget):
    def __init__(
        ...
        controls_top.setSpacing(10)
        controls_top.addWidget(self.timer_tile, 0, Qt.AlignLeft | Qt.AlignTop)
        ...
        controls_top.addLayout(notes_col)
        controls_top.addLayout(ratings)
        controls_top.addStretch()
        left_controls_col.addLayout(controls_top)
        left_controls_col.addWidget(QLabel("Reading Context"))
        left_controls_col.addWidget(self.queue_outline_tree, 1)
        left_controls_col.addWidget(QLabel("Review History"))
        left_controls_col.addWidget(self.review_history_list)
        left_controls_col.addWidget(self.full_history_btn)
