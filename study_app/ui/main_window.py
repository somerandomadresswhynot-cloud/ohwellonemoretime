...
class StudyQueuePage(QWidget):
    def __init__(
        ...
        self.pre_note_btn.setMinimumHeight(34)
        self.post_note_btn.setMinimumHeight(34)
        self.pre_note_btn.setMinimumWidth(260)
        self.post_note_btn.setMinimumWidth(260)
        self.queue_outline_tree.setMinimumHeight(210)
        self.queue_outline_tree.setMaximumHeight(240)
        self.review_history_list.setMinimumHeight(96)
        self.review_history_list.setMaximumHeight(126)

        left_controls_col = QVBoxLayout()
        left_controls_col.setSpacing(8)

        timer_section = QWidget()
        timer_section_l = QVBoxLayout(timer_section)
        timer_section_l.setContentsMargins(0, 0, 0, 0)
        timer_section_l.addWidget(self.timer_tile, 0, Qt.AlignHCenter)
        left_controls_col.addWidget(timer_section)

        notes_section = QWidget()
        notes_section_l = QVBoxLayout(notes_section)
        notes_section_l.setContentsMargins(0, 0, 0, 0)
        notes_section_l.setSpacing(6)
        notes_section_l.addWidget(self.pre_note_btn)
        notes_section_l.addWidget(self.post_note_btn)
        left_controls_col.addWidget(notes_section)
        ...
        right_pdf_col.addLayout(queue_annotation_controls)
